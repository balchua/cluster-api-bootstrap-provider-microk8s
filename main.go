...
import (
	...
	"github.com/balchua/cluster-api-bootstrap-provider-microk8s/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "e4d8825e.cluster.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&controllers.Microk8sConfigReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("Microk8sConfig"),
